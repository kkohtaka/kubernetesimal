...
import (
	...
	versioned "github.com/kkohtaka/kubernetesimal/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kkohtaka/kubernetesimal/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kkohtaka/kubernetesimal/pkg/client/listers/github/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GithubV1alpha1().Repositories(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GithubV1alpha1().Repositories(namespace).Watch(options)
			},
		},
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&githubv1alpha1.Repository{}, f.defaultInformer)
}
