...
type Interface interface {
	...
	Github() githubv1alpha1.GithubV1alpha1Interface
}
...
// Deprecated: Github retrieves the default version of GithubClient.
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.githubV1alpha1, err = githubv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.githubV1alpha1 = githubv1alpha1.NewForConfigOrDie(c)
