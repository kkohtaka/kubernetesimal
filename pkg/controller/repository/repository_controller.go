...
// Add creates a new Repository Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to Repository
	err = c.Watch(&source.Kind{Type: &githubv1alpha1.Repository{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Repository - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &githubv1alpha1.Repository{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=github.kkohtaka.org,resources=repositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=github.kkohtaka.org,resources=repositories/status,verbs=get;update;patch
func (r *ReconcileRepository) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Repository instance
	instance := &githubv1alpha1.Repository{}
