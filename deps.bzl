...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:2owttiA8Oa+J3idFeq8TSnNpm4y6AOGPI3PDbIpp2cE=",
        version = "v0.27.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:vEyy/PVMbPMCPutrssCVHCf0JNZ0Px+YqPi82K2ALlk=",
        version = "v0.27.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:DyZS1fJkv73tEy7rWv4VF6NwGeJ7SKvNaLRXZBYLA+4=",
        version = "v0.27.0",
    )
    go_repository(
