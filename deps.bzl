...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:NIl24d4eiLJPM0vKn4HjLYM+UZf6gSfi9Z+NmCxkWbk=",
        version = "v1.15.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:rk5I7PaOk5NGQHfHR2Rz6MgdA8AYQSHwsigFsOxEC1c=",
        version = "v1.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MOeyNzoSvrn4/08FtGint7wwodzSXdXefoi6bPsBhVM=",
        version = "v1.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jZTCkRRd08nxD6w7rIaZeDNGZGGQstH3SfLQ3ZsKICk=",
        version = "v1.15.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:5Fwje4O2ooOxkfyqI/kJwxWotggDLix4BSAvpE1wlpo=",
        version = "v1.15.0",
    )
    go_repository(
