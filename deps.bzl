...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:YINKfuHZ8n72tPOqSPZBwGiDpew2CJS48mdM5W8LZQU=",
        version = "v0.12.4",
    )
    ...
    go_repository(
        ...
        sum = "h1:QP8fJuXu882ztf6dsqJsso/Btm94pMd68TAZC1rE6KI=",
        version = "v0.25.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BLQ88qkfy1+zZK2+RuZUI8kBTC6QUchmNw8jTyhUCls=",
        version = "v0.56.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:4t9zuDlHLcIx0ZEhmXEeFVCRsiOgpgn2QOH9N0MNjPI=",
        version = "v0.57.0",
    )
    go_repository(
